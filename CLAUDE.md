...
**⚡ 重要: Claudeの役割制限（2025-07-29更新）**
- 設計書・要件定義の作成は禁止
- **🚫 開発作業完全休止**: Sub-Agent機能復旧まで新規実装作業停止
- 監視・保守・記録作業のみ継続
- 余計な設計文書作成は即座に削除対象
...
**🎯 現在のプロジェクト状況（2025-07-29更新）:**
- **MT5データ構造問題完全解決**: 44.1%時系列逆転を5層検証で解明
- **JamesORB統計分析完了**: 年利30.6%、PF1.205、DD43.8%
- **デモ運用継続中**: 300万円、EURUSD、2025-07-24 23:47開始
- **🚫 開発作業休止**: Sub-Agent機能利用可能まで新規開発・実装作業完全停止
