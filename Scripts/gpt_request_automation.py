...
class GPTRequestAutomation:
    def __init__(self, project_dir):
        ...
        self.checklist_file = self.project_dir / "3AI_collaboration" / "to_chatgpt" / ".request_checklist.json"
...
'''
    ...
    def run_pre_request_check(self):
        ...
        print("2. 依頼文テンプレート使用: python3 Scripts/gpt_request_automation.py --template [type]")
    ...
    def main(self):
        ...
        parser.add_argument("--template", choices=["refactoring", "analysis", "implementation", "general"], 
                          help="テンプレート生成")
        parser.add_argument("--create-hook", action="store_true", help="pre-commitフック作成")
        ...
        if args.create_hook:
            ...
            return 0 if all(r['status'] in ['ok', 'warning'] for r in results.values()) else 1
